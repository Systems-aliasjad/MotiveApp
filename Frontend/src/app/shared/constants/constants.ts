...
QAIPTVCL1:'QA-IPTV-CL1',
QAIPTVCL2:'QA-IPTV-CL2',
...
export const infoImgSrc: string = 'assets/images/super-icons/icon_supericon_all_warning_warning_consumer_regular.svg';
