...
export class CustomerJourneyConstants {
  ...
  public static requestNotFoundTrackComplaint = {
    header: 'MESSAGES.REQUEST_NOT_FOUND',
    paragraphs: ['MESSAGES.SORRY_WE_COULDNT_FIND_THE_REQUEST_YOU_REQUESTED_IF_YOU_NEED_HELP_WITH_A_TECHNICAL_ISSUE_TAP_CONTINUE_TO_TROUBLESHOOTING'],
  };
  ...
  public static resetWifiSuccessfullyCase1 = {
    ...
    paragraphs: ['MESSAGES.PLEASE_WAIT_FOR_2_MINUTES_AND_THEN_TRY_CONNECTING_TO_THE_WIFI_NETWORK_WITH_THE_NEW_PASSWORD'],
  };
  ...
  public static serviceUnavailable = {
    ...
    //  'MESSAGES.EXPECTED_DATE_OF_COMPLETION'],
  };
  ...
  public static unableToConnectWifiNetwork = {
    ...
    paragraphs: [
      'MESSAGES.MAKE_SURE_TO_SELECT_YOUR_WIFI_NETWORK_NAME_USE_THE_CORRECT_WIFI_PASSWORD_WHILE_CONNECTING_TO_YOUR_WIFI_NETWORK',
      'MESSAGES.WE_CAN_HELP_YOU_TO_RESET_WIFI_SETTINGS_IF_YOU_FORGOT_YOUR_WIFI_PASSWORD',
    ],
  };
