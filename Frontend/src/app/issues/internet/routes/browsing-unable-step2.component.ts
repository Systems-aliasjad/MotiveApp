...
export class BrowsingUnableStep2Component implements OnInit, OnDestroy {
  ...
  updatePageContent() {
    ...
    this.careContent.body1 =
      'MESSAGES.SELECT_THE_OPERATING_SYSTEM_AND_TYPE_OF_CONNECTIVITY_WIFI_OR_LAN_CABLE_FROM_THE_DROPDOWN_MENU_IN_ORDER_TO_LEARN_MORE_ABOUT_DNS_CONFIGURATION';
    this.careContent.body2 = 'MESSAGES.PLEASE_MAKE_SURE_THAT_YOUR_PC_LAPTOP_BROWSER_IS_CONFIGURED_WITH_THE_CORRECT_DNS_SETTINGS';
  }
