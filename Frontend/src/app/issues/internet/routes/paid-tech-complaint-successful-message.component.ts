...
export class PaidTechComplaintSuccessfulMessageComponent implements OnInit, OnDestroy {
  ...
  updatePageContent() {
    ...
    this.Section1Data = {
    header: 'MESSAGES.TECHNICIAN_VISIT_REQUEST_RAISED_SUCCESSFULLY',
    paragraphs: ['MESSAGES.WE_HAVE_RECEIVED_YOUR_TECHNICIAN_VISIT_REQUEST_AND_BOOKED_AN_APPOINTMENT_OUR_TECHNICIAN_WILL_CONTACT_YOU_SOON'],
  };
