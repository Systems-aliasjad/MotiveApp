 ...
 */
@Component({
  selector: 'unable-elife-error-occur-try-again-later',
...
export class UnableElifeTryAgainErrorComponent implements OnInit, OnDestroy {
  ...
  updateHeader() {
    ...
    if (this.sharedService.getTryAgainUnableElifeFlag() > 3) {
